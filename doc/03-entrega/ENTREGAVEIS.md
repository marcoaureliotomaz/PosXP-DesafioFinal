...
- [target/site/jacoco/index.html](C:/Gryphem/Projetos/PosXP/PosXP-DesafioFinal/target/site/jacoco/index.html)
- [target/site/jacoco/jacoco.csv](C:/Gryphem/Projetos/PosXP/PosXP-DesafioFinal/target/site/jacoco/jacoco.csv)
- [target/site/jacoco/jacoco.xml](C:/Gryphem/Projetos/PosXP/PosXP-DesafioFinal/target/site/jacoco/jacoco.xml)

## Itens Atendidos Pelo Projeto

- API REST no padrao MVC
- CRUD completo dos dominios `Cliente`, `Produto` e `Pedido`
- busca por ID, nome, status e contagem
...
- execucao via Docker
- diagramas C4 e diagramas de sequencia

## Sugestao De Icones Para O README

Uso recomendado, com moderacao:
...
Exemplo de uso discreto em titulos:
...
- usar icones apenas em titulos principais
- evitar icones em todos os bullets
- manter no maximo 4 ou 5 icones em todo o README
